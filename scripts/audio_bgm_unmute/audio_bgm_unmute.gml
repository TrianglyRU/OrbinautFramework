...
/// @param {Real} _fade_multiplier	Fade-in time multiplier, where 1 corresponds to a normal duration of 0.5 seconds.
...
function audio_bgm_unmute(_fade_multiplier, _index = 0)
{
    ...
    if _bgm_index != undefined
    {
        ...
        audio_sound_gain(_bgm_index, 1, _fade_multiplier * 500);
    }
}