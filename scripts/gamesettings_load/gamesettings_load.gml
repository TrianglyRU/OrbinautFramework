function gamesettings_load()
{
	...
	Game.DropdashEnabled = ini_read_real("Gameplay", "Dropdash", 1);
	...
	Game.WindowSize		  = ini_read_real("Video", "WindowSize",  1);
	Game.WindowFullscreen = ini_read_real("Video", "Fullscreen",  1);
