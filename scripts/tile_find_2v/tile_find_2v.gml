/// @function tile_find_2v(x1,y1,x2,y2,toPositive,noTopSolid,objectAngle,tilelayer)
function tile_find_2v(x1,y1,x2,y2,toPositive,noTopSolid,objectAngle,tilelayer)
{
	// Get tiles at positions
	var FindTile1 = tile_find_v(x1, y1, toPositive, noTopSolid, tilelayer);
	var FindTile2 = tile_find_v(x2, y2, toPositive, noTopSolid, tilelayer);
