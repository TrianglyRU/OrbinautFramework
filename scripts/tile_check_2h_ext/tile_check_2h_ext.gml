/// @self
/// @description												Checks for tile collision horizontally between two positions and returns an array containing the distance to the nearest surface, its angle, and the index of the closest point.
...
/// @returns {Array<Real>}
function tile_check_2h_ext(_x1, _y1, _x2, _y2, _dir, _secondary_layer = COLLISION_LAYER.PATH_A, _quadrant = QUADRANT.DOWN)
{
    var _data1 = tile_check_h_ext(_x1, _y1, _dir, _secondary_layer, _quadrant);
    var _data2 = tile_check_h_ext(_x2, _y2, _dir, _secondary_layer, _quadrant);
