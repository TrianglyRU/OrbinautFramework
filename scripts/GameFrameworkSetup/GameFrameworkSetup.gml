function GameFrameworkSetup()
{
	...
	Game.ConstantRollFrc		 = true;	// In SK, rolling friction is hard-coded to always be half of regular acceleration, event when Super
	...
	Game.OriginalRollLimit		 = true;	// In originals, when you roll the game limits your xsp instead of inertia, causing desync when launching on ramps
