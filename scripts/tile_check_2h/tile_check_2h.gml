/// @self
/// @description												Checks for tile collision horizontally between two positions and returns the distance to the nearest surface.
...
/// @returns {Real}
function tile_check_2h(_x1, _y1, _x2, _y2, _dir, _secondary_layer = COLLISION_LAYER.PATH_A, _quadrant = QUADRANT.DOWN)
{
    var _dist1 = tile_check_h(_x1, _y1, _dir, _secondary_layer, _quadrant);
    var _dist2 = tile_check_h(_x2, _y2, _dir, _secondary_layer, _quadrant);
