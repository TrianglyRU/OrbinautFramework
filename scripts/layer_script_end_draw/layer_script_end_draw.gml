/// @self
/// @description				A wrapper around layer_script_end() that executes the callback only during the normal Draw event.
...
function layer_script_end_draw(_layer_id, _script)
{
	var _data = { script: _script };
		
	layer_script_end(_layer_id, method(_data, function()
	{
