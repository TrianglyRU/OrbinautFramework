...
/// @returns {Array<Real>}
function tile_raycast_2h(_x1, _y1, _x2, _y2, _dir, _secondary_layer = COLLISION_LAYER.PATH_A, _quadrant = QUADRANT.DOWN)
{
    var _tile_data1 = tile_raycast_h(_x1, _y1, _dir, _secondary_layer, _quadrant);
    var _tile_data2 = tile_raycast_h(_x2, _y2, _dir, _secondary_layer, _quadrant);
