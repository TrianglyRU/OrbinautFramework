/// @function object_check_tiles_v(xSide, ySide, maxDistance, tileLayer)
function object_check_tiles_v(xSide, ySide, maxDistance, tileLayer)
{	
	...
	switch ySide
	{
		case SideTop :    var checkY = floor(y - objYRadiusSolid - maxDistance);     break;
		case SideBottom : var checkY = floor(y + objYRadiusSolid + maxDistance - 1); break;
