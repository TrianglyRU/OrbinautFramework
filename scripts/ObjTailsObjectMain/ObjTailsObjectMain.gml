function ObjTailsObjectMain()
{
	...
	switch Player.Animation
	{
		...
		case AnimLookup:
		case AnimCrouch:	
			animation_set(spr_tails_tail_idle, 8, 0, 0);
		break;
		case AnimSpin:
			animation_set(spr_tails_tail_type1, 4, 0, 0);
		break;
		case AnimSpindash:
			animation_set(spr_tails_tail_type2, 4, 0, 0); 
		break;
		case AnimPush:
		case AnimSkid:
			animation_set(spr_tails_tail_type3, 4, 0, 0);
		break;
		case AnimFly:
			animation_set(spr_tails_tail_fly, Player.Ysp ? 2 : 1, 0, 0);		
		break;
		case AnimFlyTired:
			animation_set(spr_tails_tail_fly, 2, 0, 0);
		break;
		default:
			animation_set(spr_tails_tail_hidden, 0, 0, 0);
		break;
	}
